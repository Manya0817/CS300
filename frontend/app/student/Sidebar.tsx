    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        ...
        >
          <Home 
            size={24} 
            color={activePage === 'dashboard' ? "#E0B1CB" : "#FFFFFF"} 
          />
          <Text 
            style={[
              styles.menuItemText, 
        ...
        >
          <Bell 
            size={24} 
            color={activePage === 'notifications' ? "#E0B1CB" : "#FFFFFF"} 
          />
          <Text 
            style={[
              styles.menuItemText, 
        ...
        >
          <Calendar 
            size={24} 
            color={activePage === 'events' ? "#E0B1CB" : "#FFFFFF"} 
          />
          <Text 
            style={[
              styles.menuItemText, 
        ...
        >
          <User 
            size={24} 
            color={activePage === 'profile' ? "#E0B1CB" : "#FFFFFF"} 
          />
          <Text 
            style={[
              styles.menuItemText, 
...
const styles = StyleSheet.create({
  container: {
    ...
    maxWidth: 300,
    height: '100%',
    backgroundColor: 'rgba(35, 25, 66, 0.97)',
    zIndex: 999,
  ...
  userAvatarContainer: {
    ...
    height: 80,
    borderRadius: 40,
    backgroundColor: 'rgba(94, 84, 142, 0.5)',
    alignItems: 'center',
  ...
  activeMenuItem: {
    backgroundColor: 'rgba(224, 177, 203, 0.15)',
  },
  menuItemText: {
    fontSize: 16,
    fontWeight: '600',
